   ...
   <div class="col-md-12">
      <div class="box">
         <div class="box-header">
            <h3 class="box-title">Mis Impresiones</h3>
            <div class="box-tools">
               ...
               <tbody>
                  @foreach ($publicidades as $publicidad) 
                     <tr>
                        ...
                        <td><center>
                           <a href="{{ route('banner-publicitario.detalle-publicacion', $publicidad->id) }}" class="btn btn-primary btn-xs">Ver Más <i class="fa fa-eye"></i></a>
                        </td>
                     </tr>
                  @endforeach
               </tbody>
