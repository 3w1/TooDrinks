...
@section('content-left')
   ...
   <ul class="nav nav-pills">
      <li class="btn btn-default"><a href="{{ route('demanda-distribuidor.index') }}"><strong>MIS BÚSQUEDAS ACTIVAS</strong></a></li>
   	...
   	<li class="active btn btn-default"><a href="{{ route('demanda-distribuidor.historial') }}"><strong>HISTORIAL DE BÚSQUEDAS</strong></a></li>
   </ul>
				         ...
				         <table class="table table-hover">
               		   ...
               		   <tbody>
               				@if ($cont > 0)
						         ...
						         @else
						         	<tr>
					            		<td colspan="5"><strong>Actualmente no posee búsquedas de distribuidores en su historial.</strong></td>
						            </tr>
									@endif
               			</tbody>
            			</table>
      	...
      	<div class="panel-body">
         	<div class="tab-content">
            	<div class="tab-pane fade in active">
                  @include('distribucion.tabs.filtroHistorial')
            	</div>
         	</div>
      	</div>
   	</div>
