                  ...
                  <tbody>
                     @foreach ($demandas as $demanda) 
                        <tr>
                           ...
                           <td><center>{{ $demanda->productor->nombre}} </center></td>
                           <td><center>
                              <a href="{{ route('demanda-importador.show', $demanda->id) }}" class="btn btn-primary btn-xs"> Detalles <i class="fa fa-eye"></i></a></td>
                           </center></td>
                        </tr>
                     @endforeach
                  </tbody>
