	            ...
	            <div class="tab-content">
	                <div class="tab-pane fade in active" id="tab1default">
	                	...
	                	<div class="form-group">
							...
							{!! Form::text('nombre', $distribuidor->nombre, ['class' => 'form-control', 'required'] ) !!}
						</div>
	                ...
	                <div class="tab-pane fade" id="tab2default">
						...
						<div class="form-group">
							...
							{!! Form::select('pais_id', $paises, $distribuidor->pais_id, ['class' => 'form-control', 'id' => 'pais_id', 'onchange' => 'cargarProvincias();', 'required']) !!}
						</div>
	                ...
	                <div class="tab-pane fade" id="tab4default">
						...
						<div class="form-group">
							...
							{!! Form::text('facebook', $distribuidor->facebook, ['class' => 'form-control'] ) !!}
						</div>
