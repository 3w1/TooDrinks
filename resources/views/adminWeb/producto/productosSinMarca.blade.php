...
{!! Html::script('js/adminWeb/buscarMarca.js') !!}
...
@section('content-left')   
   ...
   @include('adminWeb.producto.modales.asociarMarca')
      ...
      <div class="col-md-4 col-xs-6">
         <div class="thumbnail">
            ...
            <div class="caption">
               ...
               <p><center>
                  <a href="#" class="btn btn-primary" onclick="cargarModal({{$producto->id}});">Asociar Marca</a>
               </center></p>
            </div>
         </div>
      </div>
