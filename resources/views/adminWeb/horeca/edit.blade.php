...
@section('content-left')
	...
	@include('adminWeb.horeca.modales.editAvatar')

	{!! Form::open(['route' => ['admin.horeca-update', $horeca->id], 'method' => 'PUT']) !!}
	            ...
	            <div class="tab-content">
	                ...
	                <div class="tab-pane fade" id="tab3default">
						...
						<div class="form-group">
							...
							{!! Form::email('email', $horeca->email, ['class' => 'form-control', 'required'] ) !!}
						</div>    	
	                </div>
	    ...
	    <div class="form-group">
			{!! Form::submit('Actualizar Horeca', ['class' => 'btn btn-primary pull-right']) !!}
		</div>
    {!! Form::close() !!}
@endsection