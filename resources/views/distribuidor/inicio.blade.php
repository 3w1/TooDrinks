                	...
                	<?php $cont++; ?>
	                  <li>
	                 	<img src="{{ asset('imagenes/importadores/thumbnails') }}/{{ $importador->logo}}">
	                  	<span class="users-list-name">{{$importador->nombre}} ({{$importador->provincia_region->provincia}})</span>
...
@section('content-right')
    ...
    <div class="info-box bg-green">
        ...
        <div class="info-box-content">
            <span class="info-box-text">Solicitudes de Distribuidor</span>
            <span class="info-box-number">{{$solicitudesDistribuidor->cant}}</span>
