<div class="user-panel">
   <div class="pull-left image">
      <img src="{{ asset('imagenes/importadores/')}}/{{ session('perfilLogo') }}" class="img-circle" alt="User Image">
   </div>
   <div class="pull-left info">
      <p>{{ session('perfilNombre') }}</p>
      <a href="{{ route('importador.edit', session('perfilId')) }}"><i class="fa fa-edit text-success"></i> Editar Perfil</a>
   </div>
</div>
