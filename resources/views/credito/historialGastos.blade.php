                     ...
                     <tr>
                        ...
                        <td><center>
                           ...
                           @elseif ($gasto->tipo_deduccion == 'SI')
                              <a href="{{ route('solicitud-importacion.show', $gasto->accion_id) }}" class="btn btn-primary btn-xs"> Detalles <i class="fa fa-eye"></i></a></td>
                           @elseif ($gasto->tipo_deduccion == 'SD') 
                              <a href="{{ route('solicitud-distribucion.show', $gasto->accion_id) }}" class="btn btn-primary btn-xs"> Detalles <i class="fa fa-eye"></i></a></td>
