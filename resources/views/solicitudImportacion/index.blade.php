...
@section('items')
   @if (Session::has('msj'))
	...
	<span><strong><h3>Mis Solicitudes de Importación</h3></strong></span>
@endsection
...
@section('content-left')
   <div class="row">
      <div class="col-md-12">
                  ...
                  <tbody>
                     @foreach ($solicitudesImportacion as $solicitudImportacion)
                        ...
                        <tr>
                           ...
                           @endif
                           <td><center><a href="{{ route('solicitar-importacion.edit', $solicitudImportacion->id) }}" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i></a></td>
                        </tr>
                     @endforeach
                  </tbody>
               </table>
         ...
         <center>{{ $solicitudesImportacion->render() }}</center>
      </div>
   </div>
@endsection