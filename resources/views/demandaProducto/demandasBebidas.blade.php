...
@section('content-left')
   @if ( (session('perfilSuscripcion') != 'P') && (session('perfilSaldo') < '30') )
      <div class="alert alert-danger">
         No tiene créditos suficientes para ver demandas de bebidas. Por favor compre créditos. <a href="">Ver Planes de Crédito</a> O consiga una Suscripción Premium. <a href="">Ver Suscripciones</a> 
      </div>
   @endif
   <div class="row">
      <div class="col-md-12">
