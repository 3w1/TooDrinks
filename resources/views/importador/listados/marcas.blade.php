			...
			<div class="col-md-6 col-xs-12">
          		...
          		<div class="box box-widget widget-user-2">
            		...
            		<div class="box-footer no-padding">
                        ...
                        <li class="active"><a href="{{ route('importador.productos', [$marca->id, $marca->nombre]) }}"><strong><u>Catálogo de Productos: </strong> {{ $cont }} Producto(s) </u></a></li>
                        <li class="active"><a href="{{ route('importador.registrar-producto', [$marca->id, $marca->nombre]) }}"><strong><u>Agregar Producto</u></strong></a></li>
                        <li class="active"><a href="{{ route('importador.marca', [$marca->id, $marca->nombre]) }}"><strong><u>Ver más detalles</u></strong></a></li>
                     </ul>
            		</div>
         		</div>
          		<!-- /.widget-user -->
