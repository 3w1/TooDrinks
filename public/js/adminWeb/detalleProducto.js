function cargarDetalles($id){
    //var route = "http://www.toodrinks.com/consulta/cargar-detalles-producto/"+$id+"";
    var route = "http://localhost:8000/consulta/cargar-detalles-producto/"+$id+"";
    ...
    $.ajax({
        ...
        success:function(ans){
            ...
            document.getElementById("detalles").innerHTML += "<li class='active'><a><strong>Origen: </strong>"+ans.pais.pais+"</a></li>";
